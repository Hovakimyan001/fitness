    ...
    <div className="contact-container">
      <div className="contact-text">
        ...
        <label>
          ...
          <p>
            Присоединяйся в мой телеграмм-канал "База знаний LINNIK FITNESS" где
            я публикую статьи для фитнес-тренеров и любителей – о женском
            фитнесе, рациональном питании и поиске клиентов
          </p>
        </label>
